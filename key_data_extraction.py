...
class Person(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="The first name of the person")
...
comment = "I absolutely love this product! It's been a game-changer for my daily routine. The quality is top-notch and the customer service is outstanding. I've recommended it to all my friends and family. - Vaishakhi Johnson, USA"
